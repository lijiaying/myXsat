...
(define-fun f_1 () (_ FloatingPoint 8 24) (fp #b0 #b00000000 #b00000000000000000000001))
(define-fun f_2 () (_ FloatingPoint 8 24) (fp #b0 #b00000000 #b00000000000000000000001))
(define-fun f_3 () (_ FloatingPoint 8 24) (fp #b0 #b00000000 #b00000000000000000000011))
(define-fun f_4 () (_ FloatingPoint 8 24) (fp #b0 #b00000000 #b00000000000000000000100))
(define-fun f_5 () (_ FloatingPoint 8 24) (fp #b0 #b00000000 #b00000000000000000000101))

(define-fun f_1_1 () (_ FloatingPoint 8 24) (fp #b0 #b00000001 #b00000000000000000000001))
(define-fun f_1_2 () (_ FloatingPoint 8 24) (fp #b0 #b00000001 #b00000000000000000000011))
...
(define-fun right_bound () (_ FloatingPoint 8 24) f_1_3)
